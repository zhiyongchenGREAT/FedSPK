...
# make directory G1_2
import os
os.mkdir('/nvme/zhiyong/fllearn_data/G1_2')

for i in b_list:
    c = glob.glob(i+'/*')
    for j in c:
        label = j.split('/')[-3]
        out_path = '/nvme/zhiyong/fllearn_data/G1_2/'
        generate_wave(j, out_path+label+'_'+j.split('/')[-2]+'_'+j.split('/')[-1])
        with open('/nvme/zhiyong/fllearn_data/train_list_G1_2.txt', 'a') as f:
...
# make directory G2_2
import os
os.mkdir('/nvme/zhiyong/fllearn_data/G2_2')

for i in b_list:
    c = glob.glob(i+'/*')
    for j in c:
        label = j.split('/')[-3]
        out_path = '/nvme/zhiyong/fllearn_data/G2_2/'
        generate_wave(j, out_path+label+'_'+j.split('/')[-2]+'_'+j.split('/')[-1])
        with open('/nvme/zhiyong/fllearn_data/train_list_G2_2.txt', 'a') as f:
            f.write(label+' '+out_path+label+'_'+j.split('/')[-2]+'_'+j.split('/')[-1]+'\n')
...
# make directory G3_2
import os
os.mkdir('/nvme/zhiyong/fllearn_data/G3_2')

for i in b_list:
    c = glob.glob(i+'/*')
    for j in c:
        label = j.split('/')[-3]
        out_path = '/nvme/zhiyong/fllearn_data/G3_2/'
        generate_wave(j, out_path+label+'_'+j.split('/')[-2]+'_'+j.split('/')[-1])
        with open('/nvme/zhiyong/fllearn_data/train_list_G3_2.txt', 'a') as f:
            f.write(label+' '+out_path+label+'_'+j.split('/')[-2]+'_'+j.split('/')[-1]+'\n')
...
# make directory G4_2
import os
os.mkdir('/nvme/zhiyong/fllearn_data/G4_2')

for i in b_list:
    c = glob.glob(i+'/*')
    for j in c:
        label = j.split('/')[-3]
        out_path = '/nvme/zhiyong/fllearn_data/G4_2/'
        generate_wave(j, out_path+label+'_'+j.split('/')[-2]+'_'+j.split('/')[-1])
        with open('/nvme/zhiyong/fllearn_data/train_list_G4_2.txt', 'a') as f:
            f.write(label+' '+out_path+label+'_'+j.split('/')[-2]+'_'+j.split('/')[-1]+'\n')
...
# make directory G5_2
import os
os.mkdir('/nvme/zhiyong/fllearn_data/G5_2')

for i in b_list:
    c = glob.glob(i+'/*')
    for j in c:
        label = j.split('/')[-3]
        out_path = '/nvme/zhiyong/fllearn_data/G5_2/'
        generate_wave(j, out_path+label+'_'+j.split('/')[-2]+'_'+j.split('/')[-1])
        with open('/nvme/zhiyong/fllearn_data/train_list_G5_2.txt', 'a') as f:
            f.write(label+' '+out_path+label+'_'+j.split('/')[-2]+'_'+j.split('/')[-1]+'\n')
...
# make directory G6_2
import os
os.mkdir('/nvme/zhiyong/fllearn_data/G6_2')

for i in b_list:
    c = glob.glob(i+'/*')
    for j in c:
        label = j.split('/')[-3]
        out_path = '/nvme/zhiyong/fllearn_data/G6_2/'
        generate_wave(j, out_path+label+'_'+j.split('/')[-2]+'_'+j.split('/')[-1])
        with open('/nvme/zhiyong/fllearn_data/train_list_G6_2.txt', 'a') as f:
            f.write(label+' '+out_path+label+'_'+j.split('/')[-2]+'_'+j.split('/')[-1]+'\n')
